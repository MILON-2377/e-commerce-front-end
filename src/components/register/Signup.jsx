...
export default function Signup() {
  ...
  return (
    <div className=" relative flex-1 flex flex-col items-center justify-center  h-full p-5 ">
      ...
      {/* form */}
      <form className=" relative z-20 sm:w-full lg:w-[60%] flex flex-col gap-5 ">
        <label>
        ...
        <button className=" w-full bg-orange-300 text-white font-sans font-semibold px-4 py-2 rounded-3xl ">
          Submit
        </button>
      </form>
